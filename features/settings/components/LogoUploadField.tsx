  ...
  return (
    <div>
      ...
      <button
        ...
        disabled={uploading}
        className={cn(
          "relative w-full aspect-square max-w-[100px] rounded-md border-2 border-dashed transition-all duration-200",
          value
            ? "border-slate-200 bg-slate-50 overflow-hidden hover:border-slate-300"
      ...
      {value && (
        <p className="mt-0.5 text-[7px] text-slate-400">Cliquez pour remplacer</p>
      )}
    </div>
  );
}