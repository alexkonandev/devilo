...
async function main() {
  ...
  const userId = "user_2a6zR2L6q410zP90M6D6D9V7";
  ...
  const client2 = await prisma.client.create({
    data: {
      ...
      phone: "0101789012",
      address: "Boulevard Giscard d'Estaing, Abidjan",
  ...
  const client3 = await prisma.client.create({
    data: {
      ...
      phone: "0505432109",
      address: "Rue Paul Langevin, Grand-Bassam",
  ...
  console.log(`✅ SEED CLIENTS TERMINÉ : 4 clients injectés.`);
}
